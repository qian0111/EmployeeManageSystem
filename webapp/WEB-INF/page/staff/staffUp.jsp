	...
	<div class="login-form" style="height:500px">
		<form>
			<div class="form-group">
				...
				<input type="text" class="form-control" name="staffId" value="${staffInfo.id}" readonly> 
			</div>
			<div class="form-group">
				<label>用户名</label>
				<input type="text" class="form-control" name="staffName" value="${staffInfo.staffName}"> 
			</div>
			<div class="form-group">
				<label>手机号</label>
				<input type="text" class="form-control" name="phone" value="${staffInfo.phone}"> 
			</div>
				...
				<select class="form-control"  name="deptId">	
					...
					<c:forEach items="${deptList}" var="dept">
						<option value="${dept.id}"
								<c:if test="${dept.id == staffInfo.deptId}">
									selected = "selected"
								</c:if>					
							>${dept.deptName}
						</option>
